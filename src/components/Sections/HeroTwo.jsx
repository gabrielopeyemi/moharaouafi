            ...
            <div className="flex flex-wrap items-center my-10 lg:my-20">
                ...
                <div className="w-full lg:w-8/12">
                    ...
                    >
                        ...
                        <p className="text-gray-500 text-lg font-light my-4">
                            Chaque projet est une création unique, en lien avec vos valeurs et votre activité, adapté à vos besoins en communication. Afin d’affiner votre demande, je suis en étroite collaboration avec des prestataires techniques tels que développeurs web, photographes professionnels, illustrateurs.
                        </p> 
                        <p className="text-gray-500 text-lg font-light my-4">
